...
@section('pages')
    ...
    <main class="min-h-[100vh]">
        ...
        <x-hero-section judul="Kegiatan" foto="{{ asset('assets/image/hero/kegiatan.webp') }}" link="/kegiatan-organisasi" />
                ...
                <div class="w-full lg:w-[70%] lg:border-r-2 lg:pr-6">
                    ...
                    <div class="flex gap-3 text-gray-700 text-xs lg:text-sm my-5">
                        <span class="flex items-center gap-1">
                            ...
                            <span class="capitalize">{{ $data->organisasi->nama_organisasi }}</span>
                        </span>
                        <span class="flex items-center gap-1">
                        ...
                        <span class="flex items-center gap-1">
                            ...
                            <span class="capitalize">{{ strtolower($data->organisasi->nama_organisasi) }}</span>
                        </span>
                    </div>
