<!-- Main modal -->
<div id="modal-terima" tabindex="-1" aria-hidden="true" data-modal-backdrop="static"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded shadow-sm dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                <form action="{{ route('admin-kp.updatePembimbing', $data->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <button class="btn-secondary w-full mt-2"data-modal-hide="modal-terima">Tutup
                        Modal</button>
                </form>
            </div>
        </div>
