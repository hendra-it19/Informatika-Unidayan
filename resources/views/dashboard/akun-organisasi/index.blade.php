    ...
    <section class="min-h-screen">
        ...
        <div>
            <div class="w-full flex justify-between items-end">
                <form action="{{ route('akun-organisasi.index') }}" method="GET">
                    <div
                ...
                <a href="{{ route('akun-organisasi.create') }}">
                    ...
                    <tbody>
                        @forelse ($data as $r)
                            <tr class="bg-white border-b hover:bg-primary-50 text-xs">
                                ...
                                <td class="p-2">
                                    @if ($r->organisasi->can_upload)
                                        <span class="block rounded-full w-5 h-5 bg-green-500"></span>
                                    @else
                                        <span class="block rounded-full w-5 h-5 bg-red-500"></span>
                                    @endif
                                </td>
                                <td class="p-2">
                                    {{ $r->organisasi->updated_at }}
                                </td>
                                <td class="p-2 relative">
                                    ...
                                    <div
                                        class="absolute peer-focus:flex gap-1.5 bottom-1 right-0 bg-white shadow-lg rounded p-1.5 hover:flex hidden w-fit h-fit">
                                        <a href="{{ route('akun-organisasi.show', $r->organisasi->id) }}"
                                            class="inline-block w-[22px] text-primary-400 hover:text-primary-600">
                                        ...
                                        <a href="{{ route('akun-organisasi.edit', $r->organisasi->id) }}"
                                        ...
                                        <form action="{{ route('akun-organisasi.destroy', $r->organisasi->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
