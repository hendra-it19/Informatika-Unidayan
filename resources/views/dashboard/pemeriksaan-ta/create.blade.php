...
@section('pages')
    <section class="min-h-screen">
        ...
        <div class="bg-white shadow rounded px-4 py-8">
            <form action="{{ route('pengajuan-ta.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
                    ...
                    <div>
                        <label for="tujuan_judul_pertama">Tujuan</label>
                        <textarea name="tujuan_judul_pertama" id="tujuan_judul_pertama"
                            class="
                        @error('tujuan_judul_pertama')
                            input-error-ct
                        @else
                        input-ct
                        @enderror"
                            rows="5">{{ old('tujuan_judul_pertama') }}</textarea>
                        @error('tujuan_judul_pertama')
                            <div class="error-message-ct">
                                {{ $message }}
                            </div>
                    ...
                    <div>
                        <label for="tujuan_judul_kedua">Tujuan</label>
                        <textarea name="tujuan_judul_kedua" id="tujuan_judul_kedua"
                            class="
                        @error('tujuan_judul_kedua')
                            input-error-ct
                        @else
                        input-ct
                        @enderror"
                            rows="5">{{ old('tujuan_judul_kedua') }}</textarea>
                        @error('tujuan_judul_kedua')
                            <div class="error-message-ct">
                                {{ $message }}
                            </div>
                    ...
                    <div>
                        <label for="tujuan_judul_ketiga">Tujuan</label>
                        <textarea name="tujuan_judul_ketiga" id="tujuan_judul_ketiga"
                            class="
                        @error('tujuan_judul_ketiga')
                            input-error-ct
                        @else
                        input-ct
                        @enderror"
                            rows="5">{{ old('tujuan_judul_ketiga') }}</textarea>
                        @error('tujuan_judul_ketiga')
                            <div class="error-message-ct">
                                {{ $message }}
                            </div>
