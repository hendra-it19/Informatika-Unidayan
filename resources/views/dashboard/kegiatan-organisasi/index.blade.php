    ...
    <section class="min-h-screen">
        ...
        <div>
            <div class="w-full flex justify-between items-end">
                <form action="{{ route('postingan-organisasi.index') }}" method="GET">
                    <div
                ...
                @if (auth()->user()->role == 'admin' || auth()->user()->role == 'kaprodi' || auth()->user()->organisasi->can_upload == 1)
                    <a href="{{ route('postingan-organisasi.create') }}">
                ...
                @else
                    <a href="javascript:void(0)" class="cursor-not-allowed">
                        <button type="button"
                            class="text-white w-fit h-fit bg-primary-200 font-medium rounded text-sm px-1.5 py-2.5 sm:px-3 sm:py-1.5 text-center flex justify-center items-center me-1 cursor-not-allowed">
                            <svg class="me-2 h-3.5 aspect-square" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                <path fill-rule="evenodd"
                                    d="M9 7V2.221a2 2 0 0 0-.5.365L4.586 6.5a2 2 0 0 0-.365.5H9Zm2 0V2h7a2 2 0 0 1 2 2v6.41A7.5 7.5 0 1 0 10.5 22H6a2 2 0 0 1-2-2V9h5a2 2 0 0 0 2-2Z"
                            ...
                            <span class="hidden sm:inline-block">Tidak ada akses</span>
                        </button>
                    </a>
                @endif
            </div>
                            ...
                            <tr class="bg-white border-b hover:bg-primary-50 text-xs">
                                ...
                                <td class="p-2 lg:p-3 relative">
                                    ...
                                    <div
                                        ...
                                        <a href="{{ route('postingan-organisasi.edit', $r->id) }}"
                                        ...
                                        <form action="{{ route('postingan-organisasi.destroy', $r->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
