    ...
    <section class="min-h-screen">
        ...
        <div>
            ...
            <div class="flex justify-start items-center mt-2 text-sm gap-4 text-gray-700">
                <a href="{{ route('alumni.export') }}" class="flex items-center gap-0.5 hover:text-primary-500">
                ...
                <a href="{{ route('alumni.importPage') }}" class="flex items-center gap-0.5 hover:text-primary-500">
                    <svg class="w-4 aspect-square" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                        height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <tbody>
                        @forelse ($data as $r)
                            <tr class="bg-white border-b hover:bg-primary-50 text-xs">
                                ...
                                <td class="p-2">
                                    {{ $r->tahun_masuk }}<span class="uppercase">[{{ $r->status_masuk }}]</span>
                                </td>
                                <td class="p-2">
                                    {{ $r->tahun_lulus }}
                                </td>
                                ...
                                <td class="p-2 relative">
                                    ...
                                    <div
                                        ...
                                        <form action="{{ route('alumni.destroy', $r->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
