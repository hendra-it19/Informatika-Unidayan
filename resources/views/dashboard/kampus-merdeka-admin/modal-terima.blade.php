<!-- Main modal -->
<div id="modal-terima-{{ $r->id }}" tabindex="-1" aria-hidden="true" data-modal-backdrop="static"
        ...
        <div class="relative bg-white rounded shadow-sm dark:bg-gray-700">
            ...
            <div
                ...
                <button type="button"
                    ...
                    data-modal-hide="modal-terima-{{ $r->id }}">
            ...
            <div class="p-4 md:p-5">
                <form action="{{ route('admin-msib.terima-pendaftaran', $r->id) }}" method="POST"
                    onsubmit="return confirm('Apakah anda yakin ingin menentukan dosen pembimbing?')">
                    @csrf
                    @method('PUT')
                    ...
                    <button type="reset" class="btn-secondary w-full mt-2"
                        data-modal-hide="modal-terima-{{ $r->id }}">Tutup
                        Modal</button>
                </form>
            </div>
        </div>
