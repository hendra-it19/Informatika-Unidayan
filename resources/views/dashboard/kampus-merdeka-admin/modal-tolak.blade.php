    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded shadow-sm dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                <form action="{{ route('admin-msib.tolak-pendaftaran', $r->id) }}" method="POST">
                    @csrf
                    @method('PUT')


                    <div>
                        <label for="keterangan" class="label-ct">Alasan Penolakan</label>
                        <textarea class="input-ct" name="keterangan" id="keterangan" rows="5">{{ old('keterangan') }}</textarea>
                    </div>
