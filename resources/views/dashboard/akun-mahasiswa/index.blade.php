    ...
    <section class="min-h-screen">
        ...
        <div>
            <div class="w-full flex justify-between items-end">
                <form action="{{ route('akun-mahasiswa.index') }}" method="GET">
                    <div
                ...
                <a href="{{ route('akun-mahasiswa.create') }}">
            ...
            <div class="flex justify-start items-center mt-2 text-sm gap-4 text-gray-700">
                {{-- <a href="{{ route('akun-mahasiswa.export') }}" class="flex items-center gap-0.5 hover:text-primary-500">
                ...
                <a href="{{ route('akun-mahasiswa.importPage') }}" class="flex items-center gap-0.5 hover:text-primary-500">
                    <svg class="w-4 aspect-square" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                        height="24" fill="none" viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <tbody>
                        @forelse ($data as $r)
                            <tr class="bg-white border-b hover:bg-primary-50 text-xs">
                                ...
                                <td class="p-2">
                                    {{ $r->mahasiswa->tempat_lahir ?? '-' }},
                                    {{ $r->mahasiswa->tanggal_lahir ?? '-' }}
                                </td>
                                <td class="p-2">
                                    {{ $r->mahasiswa->tahun_masuk }}
                                </td>
                                <td class="p-2">
                                    {{ $r->mahasiswa->status_masuk }}
                                </td>
                                <td class="p-2">
                                ...
                                <td class="p-2 relative">
                                    ...
                                    <div
                                        ...
                                        <a href="{{ route('akun-mahasiswa.edit', $r->id) }}"
                                        ...
                                        <form action="{{ route('akun-mahasiswa.destroy', $r->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
