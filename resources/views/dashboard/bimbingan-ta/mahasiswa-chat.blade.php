@extends('layouts.dashboard-chat')

@section('pages')
    <section id="chatPage">
        <nav class="fixed top-11 mt-4 mb-6 xl:mb-10 flex px-5 py-2 text-gray-700 rounded bg-white shadow-sm"
        ...
        <div class="w-full lg:w-[80%] pt-12 m-auto mb-16">

            {{-- @livewire('chat-component', [
                'ta' => $data->id,
            ]) --}}
            @livewire('manual-chat-view', [
                'ta' => $data->id,
            ])
