            ...
            <form action="{{ route('pengajuan-ta.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
                    ...
                    <div>
                        ...
                        input-ct
                        @enderror"
                            rows="5">{{ old('tujuan_judul_pertama', $data->tujuan1) }}</textarea>
                        @error('tujuan_judul_pertama')
                            <div class="error-message-ct">
                                {{ $message }}
                            </div>
                    ...
                    <div>
                        ...
                        input-ct
                        @enderror"
                            rows="5">{{ old('tujuan_judul_kedua', $data->tujuan2) }}</textarea>
                        @error('tujuan_judul_kedua')
                            <div class="error-message-ct">
                                {{ $message }}
                            </div>
                    ...
                    <div>
                        ...
                        input-ct
                        @enderror"
                            rows="5">{{ old('tujuan_judul_ketiga', $data->tujuan3) }}</textarea>
                        @error('tujuan_judul_ketiga')
                            <div class="error-message-ct">
                                {{ $message }}
                            </div>
