        ...
        <div class="bg-white shadow rounded px-4 py-8">
            <form>
                ...
                <div class="my-3">
                    ...
                    <div id="abstrak"
                        class="w-full rounded border text-gray-700 py-2 px-3 border-gray-300 min-h-fit bg-gray-50 text-justify"
                        readonly>
                        {{ $data->abstrak }}</div>
                </div>
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-3">
                    <x-form.input type="text" name="nama" label='Pembimbing Utama' :value="$data->pembimbing_utama?->nama"
                        :readonly="true" />
                    <x-form.input type="text" name="nim" label='Pembimbing Pendamping' :value="$data->pembimbing_pendamping?->nama"
                        :readonly="true" />
                </div>
                <div class="mt-7 flex
                        gap-4 items-center">
