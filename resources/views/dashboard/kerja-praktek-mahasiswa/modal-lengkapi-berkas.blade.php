    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                ...
                <form class="space-y-4" action="{{ route('kerja-praktek.updateBerkas', $kerjaPraktek->id) }}"
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            ...
                            <div>
                                ...
                                <input type="file" name="surat_pengantar" accept="application/pdf"
                            ...
                            <div>
                                ...
                                <input type="file" name="balasan_surat_pengantar" accept="application/pdf"
                                    class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                            </div>
                            ...
                            <div>
                                ...
                                <input type="file" name="surat_penarikan" accept="application/pdf"
                                    class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                            </div>

                            <!-- Balasan Surat Penarikan -->
                            <div>
                                <label class="text-sm font-medium text-gray-900">
                                    <div class="flex items-center gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-blue-600"
                                ...
                                <input type="file" name="balasan_surat_penarikan" accept="application/pdf"
                                    class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
                            </div>
