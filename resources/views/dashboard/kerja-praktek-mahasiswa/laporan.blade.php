    ...
    <section class="min-h-screen">
        ...
        <div class="px-4 pb-6 overflow-hidden pt-4 shadow bg-white rounded relative">
            ...
            @php
                ...
                if ($tgl_selesai->dayOfWeek >= 2) {
                    $tgl_selesai = $tgl_selesai->addDay();
                }
            ...
            <div class="flex gap-5 justify-between md:justify-start items-start w-full border-b pb-3">
            ...
            <div class="flex rounded-b-md shadow overflow-hidden h-fit w-fit">
                <a href="{{ route('kerja-praktek.laporan', [
                    'kp' => $kerjaPraktek->id,
                ]) . '?laporan=harian' }}"
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between mb-0.5">
                                ...
                                @elseif ($item['isi_sekarang'])
                                    <span
                                        class="inline-flex items-center px-1 py-0.5 text-[10px] font-medium text-primary-700 bg-primary-100 rounded">
                            ...
                            @if ($item['sudah_isi'])
                                ...
                                @if (!empty($item['laporan']->review_at))
                                    <p class="text-[10px] text-gray-500 mt-3">Reviewed {{ $item['laporan']->review_at }}
                                    </p>
                                @endif
                            @endif
