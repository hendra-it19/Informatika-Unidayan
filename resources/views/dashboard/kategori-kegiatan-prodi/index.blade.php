...
@section('pages')
    ...
    <section class="min-h-screen">
        ...
        <div>
            <div class="w-full flex justify-between items-end">
                <form action="{{ route('kategori-kegiatan-prodi.index') }}" method="GET">
                    <div
                ...
                <a href="javascript:void(0)" data-modal-target="modal-tambah-kategori"
                    data-modal-toggle="modal-tambah-kategori">
                ...
                @include('dashboard.kategori-kegiatan-prodi.create')
            </div>
                                ...
                                <td class="p-2 relative">
                                    ...
                                    <div
                                        ...
                                        <a href="javascript:void(0)"
                                            data-modal-target="modal-edit-kategori-{{ $r->id }}"
                                            data-modal-toggle="modal-edit-kategori-{{ $r->id }}"
    ...
    @session('errors')
        @php
            notify()->error('Kategori serupa sudah ada!', 'Gagal');
        @endphp
    @endsession
@endsection
