<div id="modal-tambah-kategori" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded shadow dark:bg-gray-700">
            <form action="{{ route('kategori-kegiatan-prodi.store') }}" method="post">
                @csrf
                @method('post')
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                        Tambah Kategori Kegiatan Prodi
                    </h3>
                    <button type="button"
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <x-form.input label="Kategori Kegiatan" name="kategori" :value="old('kategori')" />
                </div>
                ...
                <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                    ...
                    <button data-modal-hide="modal-tambah-kategori" type="reset"
