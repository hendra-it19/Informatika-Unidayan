<li>
    <button type="button" class="w-full @if (request()->routeIs(['pemeriksaan-ta.*', 'bimbingan-ta.*', 'detail-ta.*'])) sidebar-active @else sidebar @endif"
        ...
        <li>
            <a href="{{ route('bimbingan-ta.index') }}"
                class="@if (request()->routeIs(['bimbingan-ta.*'])) sidebar-child-active
                        @else sidebar-child @endif">Bimbingan
            </a>
        </li>
    </ul>
</li>
...
<li>
    <button type="button" class="w-full @if (request()->routeIs(['review-kerja-praktek.*', 'review-kampus-merdeka.*'])) sidebar-active @else sidebar @endif"
        aria-controls="dropdown-review-dosen" data-collapse-toggle="dropdown-review-dosen">
    ...
    <ul id="dropdown-review-dosen" class="hidden py-1 space-y-0.5">
        <li>
            <a href="{{ route('review-kerja-praktek.index') }}"
                class="@if (request()->routeIs(['review-kerja-praktek.*'])) sidebar-child-active
        ...
        <li>
            <a href="{{ route('review-kampus-merdeka.index') }}"
                class="@if (request()->routeIs(['review-kampus-merdeka.*'])) sidebar-child-active
